...
func hit(_ball):
	...
	$Tween.interpolate_property($ColorRect, "rect_position:y", 30, 0, 0.5, Tween.TRANS_BOUNCE, Tween.EASE_OUT)
	$Tween.interpolate_property($Highlight, "rect_position:y", 30, 0, 0.5, Tween.TRANS_BOUNCE, Tween.EASE_OUT)
	$Tween.start()
